...
const STEP_0006: MigrationStep = {
  id: "0006_publisher_publications",
  description: "Add atomic publisher idempotency records",
  get sql(): string {
    return readMigrationSql("0006_publisher_publications.sql");
  },
} as unknown as MigrationStep;
